                ...
                <div className="flex flex-col md:flex-row md:justify-around pt-8 text-sm md:pb-20">
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-row pt-3 gap-x-3">
                            <a href="https://www.instagram.com/edisona_skola_official" className="w-8 h-8">
                            ...
                            <a href="https://www.facebook.com/edisonaskola" className="w-8 h-8">
                                <svg fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        fillRule="evenodd"
                    ...
                    <div className="flex flex-col pt-5 md:pt-0">
                        <a href="tel:+420777415125" className="underline">+420 777 415 125</a>
                        <a href="mailto:kancelar@edisona.cz" className="underline pt-1">kancelar@edisona.cz</a>
                    </div>
                    <div className="flex flex-col pt-5 md:pt-0">
