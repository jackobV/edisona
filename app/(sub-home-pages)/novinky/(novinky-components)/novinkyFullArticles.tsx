                ...
                {loading ? (
                    ...
                    <div className="flex flex-col w-full">
                        <div className="grid grid-cols-3 gap-y-10 sm:grid-cols-6 md:grid-cols-9 lg:grid-cols-12 gap-x-6 place-items-center">
                                {data.map((item)=>(
                                    <div className="col-span-3 w-full">
                                        <Aktualita title={item.title} description={item.description} thumbnail={"https://pocketbase-production-ab0e.up.railway.app/api/files/xyozhjstnob0eer/"+item.id+"/"+item.thumbnail} />
                                    </div>
                                ))}
                        </div>
                        <div className="grid grid-cols-3 gap-y-10 sm:grid-cols-6 md:grid-cols-9 lg:grid-cols-12 gap-x-6 place-items-center">
